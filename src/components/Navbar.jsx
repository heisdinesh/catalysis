    ...
    return (
      <nav className="fixed top-0 left-0 right-0 bg-[#071E22] px-12 py-3 flex justify-between items-center z-10">
          ...
          <div className="flex hidden md:block">
              ...
              <a href="#" onClick={() => {jump("faq")}} className="text-[#E5F2FF] font-medium sm:text-2xl text-[18px] sm:mr-8 mr-3">FAQ's</a>
              <a href="#" onClick={() => {jump("contact")}} className="text-[#E5F2FF] font-medium sm:text-2xl text-[18px] sm:mr-8 mr-3">Contact Us</a>
          ...
          <button
              className="text-[#E5F2FF] font-medium text-2xl focus:outline-none sm:hidden"
          ...
          <div
              className={`${
                  isOpen ? "block" : "hidden"
              } sm:hidden absolute top-24 left-0 right-0 bg-[#071E22] text-center border-2 rounded-lg pb-4`}
          >
