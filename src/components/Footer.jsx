...
import contact_gif from '../assets/contact_gif.json'
const Footer = () => {
    ...
    return (
        <div className="bg-[#071E22] mt-1" id='contact'>
            <h1 className="font-bold text-center text-5xl p-8" style={{ color: '#E5F2FF' }}>Contact Us<Lottie className='w-1/4 mt-4 mx-auto' animationData={contact_gif} /></h1>
            <footer className="text-center text-white bg-[#071E22] sm:px-[20%] px-[10%]">
                <div className="container mt-[-1.5rem] pt-9 flex justify-center mb-9">
